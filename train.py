...
def train(hyp, opt, device, tb_writer=None):
    ...
    # weight decay: sự suy giảm trọng số weight - https://d2l.aivivn.com/chapter_multilayer-perceptrons/weight-decay_vn.html
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with amp.autocast(enabled=cuda):
                # Forward
                pred = model(imgs)
                # pred = models(imgs.to(memory_format=torch.channels_last))
            ...
            if rank in [-1, 0]:
                ...
                if ni < 3:
                    ...
                    if tb_writer and result is not None:
                        ...
                        # tb_writer.add_graph(models, imgs)  # add models to tensorboard
            ...
            if save:
                with open(results_file, 'r') as f:  # create checkpoint
                    ckpt = {'epoch': epoch,
                            ...
                            'models': ema.ema.module if hasattr(ema, 'module') else ema.ema,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov4-p5.yaml', help='models.yaml path')
    ...
    parser.add_argument('--name', default='yolov4_p5', help='renames results.txt to results_name.txt if supplied')
    ...
    # Evolve hyperparameters (optional)
        ...
        print('Hyperparameter evolution complete. Best results saved as: %s\nCommand to train a new models with these '
