...
class Detect(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            # x[i].view: trỏ tới vị trí xủa x[i]
            # permute: hoán đổi vị trí
...
class Model(nn.Module):
    def __init__(self, cfg='yolov4-p5.yaml', ch=3, nc=None):  # models, input channels, number of classes
        ...
        self.model, self.save = parse_model(deepcopy(self.yaml), ch=[ch])  # models, savelist, ch_out
    ...
    def info(self):  # print models information
        model_info(self)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov4-p5.yaml', help='models.yaml')
